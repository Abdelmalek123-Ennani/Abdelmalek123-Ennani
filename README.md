...
## 👨‍💻 About Me
I'm **Abdelmalek Ennani**, a **Full Stack Engineer** passionate about creating impactful applications and solving real-world problems with technology.  

I specialize in designing, building, and deploying **scalable web applications** using modern front-end and back-end technologies.  

💡 My journey has given me solid experience in both **frontend frameworks** and **backend systems**, allowing me to deliver end-to-end solutions.  

---

## 🚀 What I Do
- **Frontend** → Craft responsive, modern UIs with **Angular, React, Ngrx ,Redux, JavaScript, TypeScript, Tailwind**  
- **Backend** → Build robust APIs and services with **Spring Boot, Flask, Java, Python**  
- **Databases** → Work with **MySQL, PostgreSQL, MongoDB** for structured & unstructured data  
- **Cloud & DevOps** → Deploy apps and pipelines with **Google Cloud Platform (GCP), Airflow, GitHub Actions**  
...
<div>
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/tailwindcss/tailwindcss-plain.svg" title="Tailwind" alt="Tailwind" width="40" height="40"/>&nbsp;
